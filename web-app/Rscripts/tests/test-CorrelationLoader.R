...
# Run the correlation analysis with given input, permutate parameters, and dump output in correct format for above tests
# After validating the output, put the input and all output files in the datasets folder.
# Also, add the input filename in the test-script above. Now, your data will be included when running this test.
